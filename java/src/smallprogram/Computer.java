...
public class Computer {
    public static void main(String[] args) {
        ...
        while (x < 10000) {
            ...
            switch (str1) {
                case "+":
                    System.out.println(c + "+" + d + "=" + tt.sum(c, d));
                    break;
                case "-":
                    System.out.println(c + "-" + d + "=" + tt.sub(c, d));
                    break;
                case "*":
                    System.out.println(c + "*" + d + "=" + tt.mul(c, d));
                    break;
                case "/":
                    System.out.println(c + "/" + d + "=" + tt.div(c, d));
                    break;
                default:
